        ...
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="search-area">
                    <form action="searchByLikeName" method="post">
                                    ...
                                    <div class="product-sorting d-flex">
                                        ...
                                        <form action="#" method="get">
                                            <select name="select" id="sortByselect">
                                                ...
                                                <option href="searchProductByCategory/asc?id={sp.category_id}" value="value">Price: low to high</option>
                                                <option value="value">Price: $ - $$</option>
                                            </select>
                                            <input type="submit" class="d-none" value="Search">
                                        </form>
                                        <c:forEach var="sp" items="${category }"> 
                                        <a href="searchProductByCategory/asc?id=${sp.category_id}">Price: low to high</a>
                                    	</c:forEach>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <p class="product-price"><span class="old-price">$75.00</span> ${sp.price }</p>
